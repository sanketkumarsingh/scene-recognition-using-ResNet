...
NUM_CLASSES = 397
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = 97392
#NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = 100
NUM_EXAMPLES_PER_EPOCH_FOR_EVAL = 10482
...
def read_cifar10(filename_queue):
  ...
  int2 = tf.cast(
      tf.slice(record_bytes, [1], [1]), tf.int32)
  result.label = int1 + int2
